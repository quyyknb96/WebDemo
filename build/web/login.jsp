            ...
            <div>
                <p>Bạn chưa có tài khoản, đến ngay với màn hình <a href="register.jsp">Đăng ký</a></p>
                    ...
                    <div class="row" style="margin: 0px;">
                        <span>Hoặc đăng nhập <a style="font-size: 18px; color: blue;" href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/demoWeb/login-google&response_type=code &client_id=253986303488-9d2474numbpmhfoflpmbr5on7tabortq.apps.googleusercontent.com&approval_prompt=force">ngay</a> với Google+</span>
                    </div>
